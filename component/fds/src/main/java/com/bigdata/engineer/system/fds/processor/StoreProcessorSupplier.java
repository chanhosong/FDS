...
//                        logger.info(KafkaConsumerConstants.LOG_APPENDER + word);
                        if (word.contains(FDSConstants.NEW_ACCOUNT_EVENT_LOG_APPENDER.toLowerCase().trim())) {
                        ...
                        } else if (word.contains(FDSConstants.DEPOSIT_EVENT_LOG_APPENDER.toLowerCase().trim())) {
                        ...
                        } else if (word.contains(FDSConstants.WITHDRAW_EVENT_LOG_APPENDER.toLowerCase().trim())) {
                        ...
                        } else if (word.contains(FDSConstants.TRANSFER_EVENT_LOG_APPENDER.toLowerCase().trim())) {
